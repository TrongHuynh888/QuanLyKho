...
const defaultPreferences: SystemPreferences = {
  ...
  lot_number_format: "{YYYYMMDD}{HHmm}{XXXX}",
...
/**
 * Provider quản lý các cài đặt cấu hình hệ thống (Preferences).
 * Xử lý việc tải, lưu trữ và cập nhật trạng thái cài đặt toàn cục ở cả phía client và gọi API backend.
 */
...
/**
 * Hook tùy chỉnh để truy xuất và cập nhật các tùy chọn cài đặt hệ thống.
 * Phải được dùng bên trong PreferencesProvider.
 */
