...
export type Product = {
  ...
  type: string | null;
  size: string | null;
  state: 'raw' | 'cooked' | 'processed' | 'packaging';
...
export type LocationWithInventory = StorageLocation & {
  ...
  utilization: number; // phần trăm 0-100
};
