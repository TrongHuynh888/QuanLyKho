...
export default function SupplierReport() {
  ...
  // Chart data: top 8 suppliers by import volume
  ...
  const handleExport = () => {
    const csv = toCSV(
      filtered.map((r) => ({ ...r })),
      [
        { key: "name", header: t("report_col_supplier") },
        { key: "contactPerson", header: t("report_col_contact") },
        { key: "phone", header: t("phone_number") },
        { key: "email", header: t("email") },
        { key: "categories", header: t("report_col_category") },
        { key: "shipmentCount", header: t("report_col_shipments") },
        { key: "totalImported", header: t("report_col_total_imported") },
        { key: "lastDelivery", header: t("report_col_last_delivery") },
        { key: "status", header: t("report_col_status") },
      ]
    );
    downloadCSV(csv, reportFilename("supplier_report"));
  };
