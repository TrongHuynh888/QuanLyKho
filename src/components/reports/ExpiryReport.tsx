...
/**
 * Component báo cáo chi tiết về hạn sử dụng (Expiry Report) của hàng hóa trong kho.
 * Hỗ trợ lọc theo trạng thái FEFO (Hết hạn, Sắp hết hạn, An toàn) và xuất CSV.
 *
 * @returns {JSX.Element} Giao diện Báo cáo Hạn sử dụng
 */
  ...
  const handleExport = () => {
    downloadExcel(
      ...
      [
        ...
        { key: "expiryDate", header: t("report_col_expiry"), width: 15 },
        { key: "daysLeft", header: t("report_col_days_left"), width: 15 },
        { key: "statusLabel", header: t("report_col_status"), width: 15 },
