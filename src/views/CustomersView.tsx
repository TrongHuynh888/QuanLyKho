 ...
 * Cung cấp tính năng thêm, sửa, xóa, lọc và tìm kiếm khách hàng.
 * @param onNavigateDetail Hàm callback điều hướng đến trang chi tiết của một khách hàng
 */
export default function CustomersView({ onNavigateDetail }: CustomersViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Lưới hiển thị danh sách khách hàng */}
      {loading ? (
