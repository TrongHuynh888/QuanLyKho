...
/**
 * Component hiển thị danh sách tất cả nhà cung cấp trong hệ thống
 *
 * @param {SuppliersViewProps} props - Props cho component
 * @param {Function} props.onNavigateDetail - Sự kiện khi chọn xem chi tiết của một nhà cung cấp
 * @returns {JSX.Element}
 */
export default function SuppliersView({ onNavigateDetail }: SuppliersViewProps) {
  ...
  /**
   * Tải danh sách nhà cung cấp của hệ thống từ API
   * @async
   */
  ...
  /**
   * Xóa một nhà cung cấp khỏi hệ thống theo ID
   * @async
   * @param {string} id - Mã định danh nhà cung cấp
   */
  ...
  const handleNavigate = (id: string, section: "details" | "history") => {
    if (typeof onNavigateDetail === "function") {
      ...
      // Cơ chế dự phòng khi không truyền onNavigateDetail
  ...
  return (
    <div className="space-y-6">
            ...
            return (
              ...
              >
                ...
                <div className="space-y-2 mb-4 flex-1">
                  ...
                  {/* Thẻ danh mục sản phẩm (Category tags) */}
      ...
      {/* Cửa sổ bật lên Form Nhà cung cấp (Modal) */}
      <AnimatePresence>
        {showModal && (
          <SupplierFormModal 
